    ...
    *  - 검증 실패시 전달할 메세지를 설정*/
    ...
    public void validate(Object target, Errors errors) {
        ...
        * */
        ...
        if (!agree) {
            errors.rejectValue("agree", "Agree", "약관에 동의해 주세요!");
        }*/
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "confirmPassword","Required","비밀번호를 입력하세요.");
